...
public class CompatitionGraphModel implements Parcelable
{
    ...
    public final static Creator<CompatitionGraphModel> CREATOR = new Creator<CompatitionGraphModel>() {
    ...
    protected CompatitionGraphModel(Parcel in) {
        ...
        in.readList(this.competitionLevel, (CompetitionLevel.class.getClassLoader()));
    }
