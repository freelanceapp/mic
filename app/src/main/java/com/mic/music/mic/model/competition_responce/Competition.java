...
package com.mic.music.mic.model.competition_responce;
...
public class Competition implements Parcelable
{
    ...
    protected Competition(Parcel in) {
        ...
        in.readList(this.competitionLevel, (com.mic.music.mic.model.competition_responce.CompetitionLevel.class.getClassLoader()));
    }
