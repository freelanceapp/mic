package com.online.music.mic.constant;
...
public class Constant {
    ...
    public static final String Comptition_Data = "Comptition_Data";
    ...
    public static final String COMPETITION_NAME_LEVEL = "COMPETITION_NAME_LEVEL";
